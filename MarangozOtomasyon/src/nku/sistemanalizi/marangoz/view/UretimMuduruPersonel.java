...
public class UretimMuduruPersonel extends JFrame {
	...
	public UretimMuduruPersonel() {
		...
		button_1.setIcon(new ImageIcon(UretimMuduruPersonel.class.getResource("/personelmaas.png")));
		...
		label_10.setIcon(new ImageIcon(UretimMuduruPersonel.class.getResource("/resimekle.png")));
		label_10.setBackground(Color.WHITE);
		label_10.setBounds(446, 84, 35, 28);
		panel_2.add(label_10);
		
		JButton btnNewButton_1 = new JButton("Ekle");
		btnNewButton_1.setIcon(new ImageIcon(UretimMuduruPersonel.class.getResource("/kaydet.png")));
		btnNewButton_1.setBounds(222, 483, 89, 23);
		panel_2.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Kaldýr");
		btnNewButton_2.setIcon(new ImageIcon(UretimMuduruPersonel.class.getResource("/sil.png")));
		btnNewButton_2.setBounds(363, 483, 89, 23);
		panel_2.add(btnNewButton_2);
		
		JButton button_2 = new JButton("G\u00FCncelle");
		button_2.setIcon(new ImageIcon(UretimMuduruPersonel.class.getResource("/guncelle.png")));
		...
		btnYenile.setIcon(new ImageIcon(UretimMuduruPersonel.class.getResource("/sil2.png")));
		...
		JLabel lblUretimMuduruPersonelleri = new JLabel("PERSONEL B\u0130LG\u0130LER\u0130");
		lblUretimMuduruPersonelleri.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 18));
		lblUretimMuduruPersonelleri.setBackground(new Color(60, 179, 113));
		lblUretimMuduruPersonelleri.setBounds(349, 32, 276, 28);
