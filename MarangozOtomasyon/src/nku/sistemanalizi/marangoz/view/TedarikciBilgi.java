...
//public class TedarikciBilgi extends JFrame {
...
public class TedarikciBilgi extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TedarikciBilgi frame = new TedarikciBilgi();
	...
	public TedarikciBilgi() {
		...
		button.setIcon(new ImageIcon(TedarikciBilgi.class.getResource("/personelekle.png")));
		...
		btnNewButton.setIcon(new ImageIcon(TedarikciBilgi.class.getResource("/personelara.png")));
		...
		button_1.setIcon(new ImageIcon(TedarikciBilgi.class.getResource("/personelmaas.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(TedarikciBilgi.class.getResource("/kaydet.png")));
		btnNewButton_1.setBounds(241, 472, 89, 23);
		panel_2.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Kaldýr");
		btnNewButton_2.setIcon(new ImageIcon(TedarikciBilgi.class.getResource("/sil.png")));
		btnNewButton_2.setBounds(382, 472, 89, 23);
		panel_2.add(btnNewButton_2);
		
		JButton button_2 = new JButton("G\u00FCncelle");
		button_2.setIcon(new ImageIcon(TedarikciBilgi.class.getResource("/guncelle.png")));
		button_2.setBounds(299, 520, 114, 22);
		panel_2.add(button_2);
		
		JLabel lbltedarikKayt = new JLabel("Tedarikçi Kay\u0131t");
		lbltedarikKayt.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 15));
		lbltedarikKayt.setBounds(241, 0, 125, 27);
		...
		btnYenile.setIcon(new ImageIcon(TedarikciBilgi.class.getResource("/sil2.png")));
		btnYenile.setBounds(313, 426, 89, 23);
		...
		JLabel label_22 = new JLabel("Tedarikçi Bilgi");
		...
		JLabel lbltedarikBilgileri = new JLabel("TEDARÝKÇÝ B\u0130LG\u0130LER\u0130");
		lbltedarikBilgileri.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 18));
		lbltedarikBilgileri.setBackground(new Color(60, 179, 113));
		lbltedarikBilgileri.setBounds(349, 32, 276, 28);
		contentPane.add(lbltedarikBilgileri);
