...
public class UretimMuduruAktifSiparis extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UretimMuduruAktifSiparis frame = new UretimMuduruAktifSiparis();
	 ...
	 * Create the frame.
	 */
	public UretimMuduruAktifSiparis() {
		...
		closeBtn2.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/kapat.png")));
		...
		label_1.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/kucult.png")));
		...
		label_2.setIcon(new ImageIcon(UretimMuduruMenu.class.getResource("/cikis.png")));
		...
		label_18.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/dxfuzanti.png")));
		...
		button_3.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/sil2.png")));
		button_3.setBounds(577, 511, 89, 23);
		panel1.add(button_3);
		
		JButton button_4 = new JButton("Ekle");
		button_4.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/kaydet.png")));
		...
		button_5.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/guncelle.png")));
		button_5.setBounds(566, 612, 114, 22);
		panel1.add(button_5);
		
		JButton button_6 = new JButton("Kald\u0131r");
		button_6.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/sil.png")));
		...
		panel2.add(label_21);
		label_21.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/print.png")));
		...
		label_36.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/dxfuzanti.png")));
		...
		button_7.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/snooze.png")));
		...
		label_61.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/cikis.png")));
		...
		label_55.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/dxfuzanti.png")));
		...
		button_8.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/gerial.png")));
		button_8.setBounds(464, 646, 127, 40);
		panel3.add(button_8);
		
		JButton button_9 = new JButton("Kald\u0131r");
		button_9.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/sil3.png")));
		...
		label_62.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/cikis.png")));
		...
		button.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/yeni.png")));
		...
		button_1.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/tamamla.png")));
		...
		button_2.setIcon(new ImageIcon(UretimMuduruAktifSiparis.class.getResource("/archive.png")));
