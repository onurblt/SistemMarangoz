...
public class MusteriBilgi extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MusteriBilgi frame = new MusteriBilgi();
	...
	public MusteriBilgi() {
		...
		button.setIcon(new ImageIcon(MusteriBilgi.class.getResource("/personelekle.png")));
		...
		btnNewButton.setIcon(new ImageIcon(MusteriBilgi.class.getResource("/personelara.png")));
		...
		button_1.setIcon(new ImageIcon(MusteriBilgi.class.getResource("/personelmaas.png")));
		...
		JLabel lblAd = new JLabel("Firma Adý*");
		...
		btnNewButton_1.setIcon(new ImageIcon(MusteriBilgi.class.getResource("/kaydet.png")));
		btnNewButton_1.setBounds(199, 469, 89, 23);
		panel_2.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Kaldýr");
		btnNewButton_2.setIcon(new ImageIcon(MusteriBilgi.class.getResource("/sil.png")));
		btnNewButton_2.setBounds(340, 469, 89, 23);
		panel_2.add(btnNewButton_2);
		
		JButton button_2 = new JButton("G\u00FCncelle");
		button_2.setIcon(new ImageIcon(MusteriBilgi.class.getResource("/guncelle.png")));
		button_2.setBounds(257, 517, 114, 22);
		panel_2.add(button_2);
		
		JLabel lblMusteriKayýt = new JLabel("M\u00FC\u015Fteri Kay\u0131t");
		lblMusteriKayýt.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 15));
		...
		btnNewButton_3.setIcon(new ImageIcon(MusteriBilgi.class.getResource("/sil2.png")));
		...
		JLabel lblMusteriBilgileri = new JLabel("Müþteri Bilgileri");
		lblMusteriBilgileri.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 18));
		lblMusteriBilgileri.setBackground(new Color(60, 179, 113));
		lblMusteriBilgileri.setBounds(377, 33, 171, 28);
		contentPane.add(lblMusteriBilgileri);
