...
public class DepoTedarikci extends JFrame {
	...
	public DepoTedarikci() {
		...
		lblNewLabel.setIcon(new ImageIcon(DepoMenu.class.getResource("/cikis.png")));
		...
		button.setIcon(new ImageIcon(DepoTedarikci.class.getResource("/personelekle.png")));
		...
		btnNewButton.setIcon(new ImageIcon(DepoTedarikci.class.getResource("/personelara.png")));
		...
		button_1.setIcon(new ImageIcon(DepoTedarikci.class.getResource("/personelmaas.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(DepoTedarikci.class.getResource("/kaydet.png")));
		btnNewButton_1.setBounds(241, 472, 89, 23);
		panel_2.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Kaldýr");
		btnNewButton_2.setIcon(new ImageIcon(DepoTedarikci.class.getResource("/sil.png")));
		btnNewButton_2.setBounds(382, 472, 89, 23);
		panel_2.add(btnNewButton_2);
		
		JButton button_2 = new JButton("G\u00FCncelle");
		button_2.setIcon(new ImageIcon(DepoTedarikci.class.getResource("/guncelle.png")));
		...
		btnYenile.setIcon(new ImageIcon(DepoTedarikci.class.getResource("/sil2.png")));
